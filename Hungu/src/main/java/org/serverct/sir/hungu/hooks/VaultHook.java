package org.serverct.sir.hungu.hooks;
...
public class VaultHook {
    ...
    private boolean setupEconomy() {
        if(Hungu.getInstance().getServer().getPluginManager().getPlugin("Vault") != null) {
            RegisteredServiceProvider<Economy> rsp = Hungu.getInstance().getServer().getServicesManager().getRegistration(Economy.class);
            if (rsp == null) {
                return false;
            }
