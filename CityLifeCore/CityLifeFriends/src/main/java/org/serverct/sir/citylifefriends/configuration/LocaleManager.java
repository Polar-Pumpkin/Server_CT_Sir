...
public class LocaleManager {
    ...
    private File dataFile = new File(CityLifeFriends.getINSTANCE().getDataFolder() + File.separator + "language.yml");
    @Getter
    ...
    public void loadLanguage() {
        if(!dataFile.exists()) {
            CityLifeFriends.getINSTANCE().saveResource("Language.yml", true);
