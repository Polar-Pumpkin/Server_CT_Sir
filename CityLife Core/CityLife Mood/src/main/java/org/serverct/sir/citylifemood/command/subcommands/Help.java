...
public class Help implements Subcommand {
    ...
    private String[] helpMsg = {
            ...
            //"  &7&o[] &9- &7&o可选参数.",
            "",
            "  &d/citylifemood help &9- &7查看帮助.",
            "  &d/citylifemood version &9- &7查看版本信息.",
            "  &d/citylifemood reload &9- &7重载插件.",
            "",
            "  &d/citylifemood do &9- &7消耗金钱回复心情.",
            "",
            "  &d/citylifemood item get &7<&c消耗品ID&7> &7<&c数量&7> &9- &7获取指定数量的指定消耗品.",
            "  &d/citylifemood item give &7<&c玩家&7> &7<&c消耗品ID&7> &7<&c数量&7> &9- &7给予指定玩家指定数量的指定消耗品.",
            "  &d/citylifemood item save &7<&c消耗品ID&7> &7<&c类型&7> &7<&c值&7> &9- &7将手持物品保存为消耗品.",
            "",
            "&d&m┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄"
    };
